...
public class ValorIndexable<T>
    ...
    @Override public int compareTo(ValorIndexable<T> valorIndexable) {
        ...
        return -1;
        */
        return Double.compare(this.valor, valorIndexable.valor);
    }
    ...
    @Override public boolean equals(Object objeto) {
        ...
        return (elemento == valorIndexable.getElemento())
        && (valor == valorIndexable.getValor());
    }
    ...
    @Override public String toString() {
        String s = "";
        s += String.valueOf(this.elemento) + ":" + String.format("%2.9f", valor);
      return s;
    }
}
